...
root.resizable(0,0)
contactlist = [
    ['Vishal Tiwari',  '0176738493'],
    ['Vedant Sharma',  '2684430000'],
    ['Mandish Singh',   '4338354432'],
    ['Vishal Rathore','6834552341'],
    ['Rahul Sharma',   '1234852689'],
    ['Vrunda Shaa' , '2119876543'],
    ]
...
Button(root,text="EXIT", font='arial 12 bold',bg='tomato', command = EXIT).place(x= 390, y=430)
